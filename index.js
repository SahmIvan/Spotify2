...
let imagenAlbum = document.getElementById("imagenAlbum");
...
fetch('https://spotify23.p.rapidapi.com/albums/?ids=6trNtQUgC8cgbWcqoMYkOR', options)
    .then(response => response.json())
    .then(response => {
        //nombreArtista.innerH
        
        console.log(response.albums[0].name); //Se obtiene esta informacion basandonos en lo que aparece en la consola a la hora de ejeccutar la api en el navegador
